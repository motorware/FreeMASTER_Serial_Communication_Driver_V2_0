...
/*****************************************************************************
* Select communication interface (LPUART/MSCAN base address)
******************************************************************************/

#define FMSTR_SCI_BASE         0x4006C000UL /* UART2_BASE base on KEA128 */
#define FMSTR_CAN_BASE         0x40024000UL /* MSCAN_BASE base on KEA128 */
