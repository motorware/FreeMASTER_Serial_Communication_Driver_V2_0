...
***************************************************************************//*!
*
* @brief  FreeMASTER Driver main API header file, KEA Cortex ARM M0+ platform
*
...
void FMSTR_Isr(void);           /* UART/MSCAN interrupt handler for LONG_INTR and SHORT_INTR modes */
